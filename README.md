...
| Group | Tools |
|---|---|
| **Context optimization** | `kern_optimize_prompt`, `kern_optimize_log`, `kern_optimize_output`, `kern_context_budget`, `kern_pack`, `kern_swap`, `kern_compact_file`, `kern_project_map`, `kern_context_watch`, `kern_prompt_fill`, `kern_stream` |
...
| **JSON adapters** | `continue`, `windsurf`, `zed`, `vscode`, `antigravity`, `qwen`, `qoder`, `kiro`, `copilot` (VS Code `.vscode/mcp.json` + CLI `~/.copilot/mcp-config.json`) | — (no hook API) |
