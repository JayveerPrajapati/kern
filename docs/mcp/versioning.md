...
The catalog is the contract clients depend on most: 121 tools at HEAD, registered in
...
- The catalog count (121) and the `ToolNames()` set are enforced by catalog-parity
