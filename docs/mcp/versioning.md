...
The catalog is the contract clients depend on most: 136 tools at HEAD, registered in
...
- The catalog count (136) and the `ToolNames()` set are enforced by catalog-parity
