...
// Suppression is one reviewed, expiring rule-file suppression, decoded
...
// . Entries are decoded via SuppressionEntry because yaml.v3 cannot
...
// OwnersFile is the raw YAML structure of .blueprint/owners.yaml.
