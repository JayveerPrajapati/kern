...
type Policy struct {
	...
	// Suppressions holds reviewed, expiring suppressions, resolved from
	...
	// Owners maps rule IDs to the team(s) responsible, resolved from
...
func (e *Engine) Evaluate(result domain.CheckResult) (domain.Status, []domain.Finding) {
	...
	// suppression: a reviewed, expiring suppression is the ONLY
