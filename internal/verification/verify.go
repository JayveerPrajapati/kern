// Agent-output cross-checking: every referenced file:line, symbol name and
// route in the agent's output text is confirmed to exist against the real
// source tree and index (or flagged as unverifiable / missing). A cheap,
