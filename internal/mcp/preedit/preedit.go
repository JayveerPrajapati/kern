...
// Analyze performs predictive blast-radius, caller sensitivity, and test-gap analysis
...
func Analyze(ctx context.Context, ix *index.Index, root string, file string, symbol string, linesStr string) (string, error) {
	if file == "" && symbol == "" {
