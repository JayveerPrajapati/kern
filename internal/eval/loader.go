...
// "baseline", "candidate", "critical_evidence", and optionally "intent" (a
// pipeline-mode case: the candidate is generated by kern orchestrate instead
// of being provided statically). Non-.json files are ignored. A malformed
// JSON file returns an error naming the file. An empty (or json-free) dir
// returns an empty slice with nil error.
