---
trigger: always_on
description: Enforce kern-first tool usage — prefer kern MCP tools over built-in file operations.
---

# kern-first rule (Windsurf)
...
- Building/testing → call `kern_validate` instead of running the build command directly.
