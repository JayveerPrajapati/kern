...
// Phase 20.4 deterministic pause-trigger helpers. These are pure, offline
...
// originalScope. Used to PAUSE on scope expansion (Phase 20.4).
...
// Used to PAUSE on a confidence drop (Phase 20.4).
...
// unexpected tool invocation (Phase 20.4).
...
// to PAUSE on an unexpected file being touched/read (Phase 20.4).
...
// Used to PAUSE on a policy change (Phase 20.4).
...
// "FAIL"). Used to PAUSE on a verification regression (Phase 20.4).
